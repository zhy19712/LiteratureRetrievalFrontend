  ...
  <el-container style="height:620px; width:100%;">
      ...
      <el-container >
          <el-header :gutter="2"  style="padding:10px; border:1px solid #eee">
            ...
            <el-col :span="15" offset="1" class='global_search_div' style=" min-width:600px;border:1px solid ">
        ...
        <!-- 文献栏位--可用el-动态编辑标签 -->
        <div :gutter="20"  style="font-size: 12px;  border:1px；height:50px;">
          <el-tabs class="header" v-model="editableTabsValue"   type="card" closable @tab-click="handleTabClick" @tab-remove="handleTabClose" style="background-color:">
            <el-tab-pane
              :key="tab.name"
